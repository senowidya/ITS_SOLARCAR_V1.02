    ...
    ui(new Ui::interfacing)
{
    ...
    ui->tbl_inputdata->horizontalHeader()->setSectionResizeMode(QHeaderView::Stretch);
    ui->tbl_inputdata->verticalHeader()->setSectionResizeMode(QHeaderView::Stretch);
...
void interfacing::on_btn_ClearGraph_clicked()
{
    int i;
    for(i=0;i<1000;i++){
        datax[i]=0;
